...
public class ServiceProduit implements IService<Produit> {
    ...
    public void ajouter(Produit produit) throws SQLException {
        ...
        if (produit instanceof Vetements) {
            ...
            Vetements vetements = (Vetements) produit;  // Cast en toute sécurité
            ...
            // Ajout dans la table accessoires
            ...
            Accessoires accessoires = (Accessoires) produit;  // Cast en toute sécurité
            ...
            System.out.println("Produit de type inconnu !");
        }
    }
